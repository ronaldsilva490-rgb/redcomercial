...
export default function Vehicles() {
  ...
  const load = useCallback(async () => {
    ...
    } catch { toast.error("Oops! Não consegui buscar veículos. Tente novamente 😕") }
  ...
  const handleSave = async () => {
    ...
    if (!form.preco) return toast.error('Tudo tem seu preço! Conta pra gente quanto isso custa 💵')
    setSaving(true)
    try {
      const payload = {
        ...form,
            ...
            <div className="modal-body">
              <div className="form-grid">
                ...
                <div>
                  ...
                  <input className="input" type="number" value={form.ano_mod || ''} placeholder={form.ano} onChange={e => f('ano_mod', e.target.value)} />
                </div>
                <div>
