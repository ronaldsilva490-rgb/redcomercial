...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (!login || !senha) {
      toast.error('Ei! Alguns campos obrigatórios ficaram vazios ✍️')
      return
    }
    ...
    if (result.ok) {
      toast.success('Tudo pronto, Chefe! Painel liberado 🚀')
  ...
  return (
    <div style={{
      ...
      {/* Botão Flutuante - Voltar para Login de Usuários */}
      <button
        ...
        title="Voltar para Login de Usuários"
      >
        <User size={24} />
      </button>
